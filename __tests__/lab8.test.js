describe('Basic user flow for Website', () => {
  ...
  it('Clicking the "Add to Cart" button should change button text', async () => {
    ...
    let jsonVal = await buttonText.jsonValue();
    // Make sure the button text is "Remove from Cart"
  ...
  it('Checking number of items in cart on screen', async () => {
    ...
    const jsonVal = await cartCountText.jsonValue();
  ...
  it('Checking number of items in cart on screen after reload', async () => {
    ...
    for(let item in prodItems) {
      ...
      const jsonVal = await buttonText.jsonValue();
      expect(jsonVal).toBe('Remove from Cart');
    }
    const cartCount = await page.$('#cart-count');
    const cartCountText = await cartCount.getProperty('innerText');
  ...
  it('Checking the localStorage to make sure cart is correct', async () => {
    ...
    const storage = await page.evaluate(() => {return localStorage.getItem('cart')});
